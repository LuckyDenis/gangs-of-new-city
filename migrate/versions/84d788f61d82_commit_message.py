...
Revision ID: 84d788f61d82
Revises: 
Create Date: 2020-11-19 16:53:54.926264
...
def upgrade():
    ...
    sa.Column('gems', sa.BigInteger(), nullable=False),
    sa.ForeignKeyConstraint(['user'], ['user.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('user')
    )
    op.create_index(op.f('ix_wallet_user'), 'wallet', ['user'], unique=False)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_wallet_user'), table_name='wallet')
